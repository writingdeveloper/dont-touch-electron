...
所有视频处理均在您的设备上本地进行，摄像头图像绝不会离开您的设备。仅收集匿名使用统计（不含个人数据和图像）以改进应用。

## 主要功能

- 基于MediaPipe的实时面部/手部检测
- 可自定义检测区域（头皮、眉毛、眼睛、脸颊等）
- 全屏警报+可自定义提示音（内置音调、多语言语音或您自己的音频）
- 每日统计和连续天数追踪
- 内置呼吸冥想
- 系统托盘支持
- 多语言界面
...
- 所有视频和图像处理在本地运行 — 摄像头画面不会离开您的设备
- 仅收集匿名使用统计（例如：应用启动、检测开始/停止）以改进应用 — 不含个人数据、图像或视频
- 分析数据按照GDPR、CCPA、PIPEDA进行处理
