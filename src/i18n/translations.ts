...
export interface Translations {
  ...
  controlStartingCamera: string;
  controlRequestingCamera: string;
  alertTimeoutButton: string;
  alertTimeoutResume: string;
  alertTimeoutRemaining: string;
  alertTimeoutQuietUntil: string;
  alertTimeoutClearToResume: string;
  alertTimeoutStartDetectionFirst: string;
  alertTimeoutSettingsTitle: string;
  alertTimeoutSettingsDesc: string;
  alertTimeoutDefaultDuration: string;
  alertTimeoutMinutesSuffix: string;

  // Activity rail
  activityPanelTitle: string;
  activityPanelShow: string;
  activityPanelHide: string;
  activityPanelSetupLabel: string;
  activityPanelPrivateSetup: string;
  activityPanelSetupTitle: string;
  activityPanelSetupBody: string;
  activityPanelSetupAction: string;
...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    statusDetecting: 'Hand nearby',
    statusAlert: 'Move hand away',
    statusCooldown: 'Resetting',
    statusProximity: 'Distance',
    statusNear: 'Near',
    statusSafe: 'Clear',

    progressAlertThreshold: 'Alert threshold',
    progressCooldownTimer: 'Reset timer',
    progressAlertIn: 'Reminder in',
    progressResumeIn: 'Ready in',

    controlStart: 'Start monitoring',
    controlStop: 'Stop monitoring',
    controlLoading: 'Preparing detection...',
    controlStartingCamera: 'Starting camera...',
    controlRequestingCamera: 'Requesting camera access...',
    alertTimeoutButton: 'Break Time',
    alertTimeoutResume: 'Resume reminders',
    alertTimeoutRemaining: 'Remaining',
    alertTimeoutQuietUntil: 'Quiet until',
    alertTimeoutClearToResume: 'Clear once to resume',
    alertTimeoutStartDetectionFirst: 'Start monitoring before taking a break',
    alertTimeoutSettingsTitle: 'Break Time default',
    alertTimeoutSettingsDesc: 'Temporarily quiet reminders while detection keeps running.',
    alertTimeoutDefaultDuration: 'Default break duration',
    alertTimeoutMinutesSuffix: 'm',

    activityPanelTitle: 'Activity panel',
    activityPanelShow: 'Show activity panel',
    activityPanelHide: 'Hide activity panel',
    activityPanelSetupLabel: 'First run setup',
    activityPanelPrivateSetup: 'Private setup',
    activityPanelSetupTitle: 'Start when you are ready',
    activityPanelSetupBody: 'The camera only starts after you press Start. Video stays on this device.',
    activityPanelSetupAction: 'Got it',

    videoCameraOffline: 'Camera is off',
    videoInitialize: 'Start monitoring when you are ready.',
    videoRec: 'REC',

    alertWarning: 'Notice',
    alertTitle: 'Hand near face',
    alertSubtitle: 'Move your hand away.',
    alertStatus: 'Status',
    alertViolation: 'Hand near face',
    alertAction: 'Next step',
    alertClearToDismiss: 'Clear to close',
    alertHandStillNear: 'Hand still near',
    alertDismissHint: 'Click or press a key once your hand is away.',
    alertMoveHandAway: 'Move your hand away first.',
    alertZoneDetected: 'Area',
    ...
    settingsSensitivityHint: 'Higher sensitivity notices hands from farther away',
    settingsTriggerTime: 'Trigger Time',
    settingsTriggerTimeHint: 'How long a hand needs to stay nearby before a reminder',
    settingsCooldownTime: 'Cooldown Time',
    settingsCooldownTimeHint: 'Time before monitoring resumes after a reminder',
    ...
    cameraError: 'Camera needs attention',
    ...
    meditationRecommend: 'Take a short reset?',
    meditationRecommendDesc: 'A brief breathing exercise can make the next few minutes easier.',
    ...
    settingsTabHabit: 'Habit support',
    settingsTabData: 'Privacy & data',
    ...
    // About
    aboutDescription: 'Local hand-near-face reminders for reducing face-touching habits.',
    ...
    aboutPrivacyText: 'Video processing runs locally on your device while monitoring is active. The app does not upload camera video to a cloud service.',
    aboutLocalOnly: 'Local Processing Only',
    aboutNoData: 'No Cloud Video Upload',
    aboutCompliance: 'Review exported statistics before sharing them; they stay on this device unless you export them.',
    ...
    settingsTabSound: 'Alerts',
    settingsAlertSound: 'Reminder sound',
    settingsAlertSoundDesc: 'Choose what plays when your hand stays near your face',
  ...
  ko: {
    ...
    progressAlertThreshold: '알림 기준',
    progressCooldownTimer: '쿨다운 타이머',
    progressAlertIn: '알림까지',
    ...
    alertWarning: '안내',
    alertTitle: '손이 얼굴 가까이에 있음',
    alertSubtitle: '손을 얼굴에서 멀리 두세요.',
    alertStatus: '상태',
    alertViolation: '손이 얼굴 가까이에 있음',
    alertAction: '다음 단계',
    alertClearToDismiss: '닫아도 됨',
    alertHandStillNear: '손이 아직 가까움',
    alertDismissHint: '아무 곳이나 클릭하거나 아무 키나 눌러서 닫기',
    alertMoveHandAway: '먼저 손을 멀리 두세요.',
    ...
    settingsTriggerTime: '알림 시간',
    settingsTriggerTimeHint: '알림이 표시되기까지의 시간',
    settingsCooldownTime: '쿨다운 시간',
    settingsCooldownTimeHint: '알림 후 재감지까지 대기 시간',
    settingsLanguage: '언어',
    settingsGeneral: '일반',
    ...
    settingsAlertSoundDesc: '손이 얼굴 가까이에 있을 때 재생될 소리를 선택하세요',
  ...
  ja: {
    ...
    progressAlertThreshold: '通知しきい値',
    progressCooldownTimer: 'クールダウンタイマー',
    progressAlertIn: '通知まで',
    ...
    alertWarning: 'お知らせ',
    alertTitle: '手が顔の近くにあります',
    alertSubtitle: '手を顔から離してください。',
    alertStatus: 'ステータス',
    alertViolation: '手が顔の近くにあります',
    alertAction: '次のステップ',
    alertClearToDismiss: '閉じられます',
    alertHandStillNear: '手がまだ近い',
    alertDismissHint: 'どこかをクリックするかキーを押して閉じる',
    alertMoveHandAway: '先に手を離してください。',
    ...
    settingsTriggerTimeHint: '通知が表示されるまでの時間',
    settingsCooldownTime: 'クールダウン時間',
    settingsCooldownTimeHint: '通知後の再検出までの待機時間',
    settingsLanguage: '言語',
    settingsGeneral: '一般',
    ...
    settingsAlertSound: '通知音',
    settingsAlertSoundDesc: '手が顔の近くにあるときに再生する音を選択',
  ...
  zh: {
    ...
    progressAlertThreshold: '提醒阈值',
    progressCooldownTimer: '冷却计时器',
    progressAlertIn: '提醒倒计时',
    ...
    settingsTriggerTimeHint: '提醒触发前的时间',
    settingsCooldownTime: '冷却时间',
    settingsCooldownTimeHint: '提醒后重新检测前的等待时间',
    settingsLanguage: '语言',
    settingsGeneral: '一般',
    ...
    settingsAlertSoundDesc: '选择手靠近脸部时播放的声音',
  ...
  es: {
    ...
    alertWarning: 'Aviso',
    alertTitle: 'Mano cerca de la cara',
    alertSubtitle: 'Aleja la mano.',
    alertStatus: 'Estado',
    alertViolation: 'Mano cerca de la cara',
    alertAction: 'Siguiente paso',
    alertClearToDismiss: 'Listo para cerrar',
    alertHandStillNear: 'Mano aún cerca',
    alertDismissHint: 'Haga clic en cualquier lugar o presione cualquier tecla para cerrar',
    alertMoveHandAway: 'Aleja la mano primero.',
    ...
    settingsTriggerTimeHint: 'Tiempo antes de mostrar el recordatorio',
    settingsCooldownTime: 'Tiempo de Enfriamiento',
    settingsCooldownTimeHint: 'Tiempo de espera después del recordatorio',
    ...
    settingsAlertSound: 'Sonido de recordatorio',
    settingsAlertSoundDesc: 'Elige qué se reproduce cuando la mano está cerca de la cara',
  ...
  ru: {
    ...
    alertWarning: 'Подсказка',
    alertTitle: 'Рука у лица',
    alertSubtitle: 'Уберите руку.',
    alertStatus: 'Статус',
    alertViolation: 'Рука у лица',
    alertAction: 'Следующий шаг',
    ...
    alertMoveHandAway: 'Сначала уберите руку.',
    ...
    settingsTriggerTimeHint: 'Время до показа напоминания',
    settingsCooldownTime: 'Время перезарядки',
    settingsCooldownTimeHint: 'Время ожидания после напоминания',
    ...
    settingsAlertSoundDesc: 'Выберите звук, когда рука находится у лица',
